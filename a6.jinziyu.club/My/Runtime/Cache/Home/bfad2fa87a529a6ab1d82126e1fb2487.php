		...
		<div class="box">
			<div class="box-header" style="min-height: 35px;">
				...
				<div class="box-tools" style="left:10px;">
						...
						<div class="form-group">
							<a href="<?php echo U(GROUP_NAME.'/Img_add');?>" class="btn btn-success" style="margin-left:10px;">添加轮播图</a>
						</div>
			...
			<div class="box-body">
				<table class="table table-bordered table-hover table-striped text-center" style="font-size: 14px;">
					...
					<tr>  	
                      <?php if(is_array($data)): foreach($data as $key=>$vo): ?><td align="center"><?php echo ($vo["id"]); ?></td>
				<td align="center"><img src="<?php echo ($vo["img"]); ?>" style="width: 100px;height:50px;"></td>
                <td align="left"><?php echo ($vo["tit"]); ?></td>
				<td align="left"><?php echo ($vo["url"]); ?></td>
                <td><?php echo (date("Y/m/d",$vo["time"])); ?></td>
							<td>	
								  <a href="<?php echo U(GROUP_NAME.'/Img_edit',array('id'=>$vo['id']));?>">编辑</a> |

								<a href="javascript:delCat('<?php echo ($vo["name"]); ?>','<?php echo U(GROUP_NAME.'/Img_del',array('id'=>$vo['id']));?>');"  class="cannel_vip btn bg-maroon margin">
