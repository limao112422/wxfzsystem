				...
				<div class="hui-list" style="background:#FFFFFF; margin-top:10px;border:0">
					...
					<div class="hui-form-items">
			            ...
			            <select name="bank" class="hui-input hui-input-clear">
			            	<?php if(is_array($bank)): foreach($bank as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
			            </select>
			        </div>
					<div class="hui-form-items">
			        	<div class="hui-form-items-title">系列</div>
			            <input type="text" class="hui-input hui-input-clear" name="name" placeholder="请输入卡片名称"  />
			        </div>
			        ...
			        <div class="hui-form-items">
			            ...
			            <input type="text" class="hui-input hui-input-clear" name="money" value="0" />
			        </div>
