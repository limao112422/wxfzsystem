		...
		<div class="box">
			<div class="box-header" style="min-height: 35px;">
				...
				<div class="box-tools" style="left:10px;">
					<form class="form-inline" method="post" action="<?php echo U(GROUP_NAME.'/User_index');?>">
			...
			<div class="box-body">
				<table class="table table-bordered table-hover table-striped text-center" style="font-size: 14px;">
					...
					<tr>
                    <form class="form-inline" method="post" action="<?php echo U(GROUP_NAME.'/User_del');?>">
                      		<div class="form-group" style="float:left">
							<a href="<?php echo U(GROUP_NAME.'/User_add');?>" class="btn btn-success" style="margin-left:10px;">添加用户</a>
						</div>	
						<div class="form-group">
                          ...
                          <th><?php echo ($vo["nick"]); ?></th>
						   ...
						   <td><?php if($vo['vip']==1) { echo '正常'; } else { echo '禁用';} ?>
							...
							<td>	
								...
								<a href="javascript:delCat('<?php echo ($vo["nick"]); ?>','<?php echo U(GROUP_NAME.'/User_del',array('Id'=>$vo['id']));?>')"   class="cannel_vip btn bg-maroon margin">
									<i class="fa fa-times"></i>删除
								</a>
                                <a href="<?php echo U(GROUP_NAME.'/User_edit',array('id'=>$vo['id']));?>"  class="cannel_vip btn bg-maroon margin" style="background:#00a65a !important">
									编辑
								</a>
