		...
		<div class="box">
			<div class="box-header" style="min-height: 35px;">
				...
				<div class="box-tools" style="left:10px;">
					<form class="form-inline" method="post" action="<?php echo U(GROUP_NAME.'/Daili_index');?>">
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" name="keyword" class="form-control" style="width:120px;" placeholder="姓名" value="<?php echo ($keyword); ?>">
							</div>
							<!--div class="input-group">
								<input type="text" name="keyword2" class="form-control" style="width:120px;" placeholder="手机号" value="">
							</div-->
							<div class="input-group">
								<input type="text" name="keyword3" class="form-control" style="width:120px;" placeholder="来源管理" value="<?php echo ($keyword3); ?>">
						...
						<div class="form-group">
							<a href="<?php echo U(GROUP_NAME.'/Daili_add');?>" class="btn btn-success" style="margin-left:10px;">添加团队</a>
						</div>
