		...
		<div class="box">
			...
			<div class="box-body">
					...
					<tr>
   					<th width="30">ID</th>
         			   ...
         			   <th width="100" align="center">操作</th>
							...
							<a href="<?php echo U(GROUP_NAME.'/Block_add');?>" class="btn btn-success" style="margin-left:10px;">添加</a>
						</div>	
                ...
                <td align="center">
                    ...
                    <a href="<?php echo U(GROUP_NAME.'/Block_edit',array('id'=>$vo['id']));?>">编辑</a> |

                    <a href="javascript:delCat('<?php echo ($vo["name"]); ?>','<?php echo U(GROUP_NAME.'/Block_del',array('id'=>$vo['id']));?>');">删除</a>
