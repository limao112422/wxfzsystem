	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U(GROUP_NAME.'/Admin_edit');?>" enctype="multipart/form-data">
                   <input type="hidden" name="editId" value="<?php echo ($data["id"]); ?>">
					<div class="box-body">
                      ...
                      <div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">账户余额</label>
							<div class="col-sm-6">
								<input type="text" name="price" class="form-control col-sm-9" value="<?php echo ($data["price"]); ?>">
							</div>
						</div>		
