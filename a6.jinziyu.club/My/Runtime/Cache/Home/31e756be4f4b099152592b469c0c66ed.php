...
<section class="content-header">
	<div>
		<ol class="breadcrumb" style="background: none; margin-bottom: 0px;">
			<li><a href="/m.php?m=Member&c=Index&a=index" style="color: #333;"><i class=" fa fa-home"></i> Home</a></li>
		</ol>
	</div>
</section>
<style>
...
<?php
$uid = session(C('USER_QUDAO_KEY')); $url="http://".$_SERVER['SERVER_NAME'].U('Register/signups',array('invitor' => $uid)); ?>
<section class="content">
	<div class="imsg"> <p>邀请卡商将享受单个任务利润<?php echo C('cfg_fencheng2');?>的抽成。您的专属邀请链接： <a class="btn" data="<?php echo $url?>" data-clipboard-text="" style="" >复制</a></p>
  		<p>  平台新增接单投诉功能，请商家务必如实反馈辅助结果，账号被投诉骗单平台将永久封号！</p>
  	</div>
			...
			<div class="box box-primary" style="border:none">
				...
				<table class="table table-bordered table-hover table-striped text-center" style="font-size: 14px;">
					...
					<tr>
   					<th width="30">当前价格</th>
           			 <th width="300" align="left">手续费率</th>
          			  <th width="140" align="left">最终价格</th>
					</tr>
	
                          <tr>
							   <td align="center"><?php echo ($yongjin); ?></td>

               				 <td align="left"><?php echo ($shouxu); ?></td>

               				 <td><?php echo round($yongjin*(1+$shouxu),2)?></td>

						</tr>		
                  </tbody>
				</table>
               <p style="color:red;text-align:center"> 小技巧：系统根据发布价格排序订单，价格越高，排序越靠前，会员优先接单。<br>订单特别多的时候低价单会沉到底部，辅助效率可能会变差。故建议爆单的时候，适当调高价格，可提升辅助效率</p>
			</div>
 				<form class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U('Qudao/Main_add');?>"enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">下单价格</label>
							<div class="col-sm-6">
								     <input type="text" name="price" value="<?php echo ($yongjin); ?>" size="30" class="inpMain" />
							</div>
						</div>					
...
<script>
  ...
  var copy2 = document.querySelectorAll('a');
