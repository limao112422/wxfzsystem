		...
		<div class="hui-wrap">
		    ...
		    <div class="hui-list" style="background:#FFFFFF; margin-top:10px;">
		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">世代数</div>
		            <input type="text" name="n" class="hui-input" value="<?php echo ($c); ?>" autofocus="autofocus" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">字 辈</div>
		            <input type="text" name="na" class="hui-input" value="" autofocus="autofocus" />
		        </div>
