...
<script type="text/javascript" charset="utf-8" src="/Public/Baidu/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/Public/Baidu/ueditor.all.js"> </script>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form id="fordw" class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U(GROUP_NAME.'/text_edit',array('id' => $data['id']));?>"enctype="multipart/form-data">
					<div class="box-body">
						
						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">名称</label>
							<div class="col-sm-6">
								       <input type="text" name="title"  size="80" value="<?php echo ($data["title"]); ?>" class="inpMain" />
							</div>
						</div>					

						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">内容</label>
							<div class="col-sm-6">
							<textarea  id="demo" style="display: none;" name="text" cols="60" rows="4" class="textArea"><?php echo ($data["text"]); ?></textarea>
				<script id="editor" type="text/plain"  style="width:100%;height:200px;"><?php echo ($data["text"]); ?></script>
							</div>
						</div>
					...
					<div class="box-footer">
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-9">
								<button type="button" onclick="tijiao()"id="ajaxBtn" class="btn btn-primary">保存</button>
							</div>
						</div>
					</div>
