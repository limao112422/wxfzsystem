		...
		<div class="box">
			<div class="box-header">
				...
				<div class="box-tools" style="left:10px;">
					<form class="form-inline" method="post" action="<?php echo U('Qudao/jieshen');?>">
			...
			<div class="box-body">
              ...
              <?php if($vo['status']==0){ echo "等待扫码";}if($vo['status']==1){ echo "正在扫码";}if($vo['status']==2){echo "等待确认";}if($vo['status']==3){echo "订单完成";}if($vo['status']==4){echo "超时退款";}if($vo['status']==5){echo "自动完成";}if($vo['status']==6){echo "扫码失败";}if($vo['status']==7){echo "订单失败";}if($vo['status']==8){echo "正在申诉";}if($vo['status']==9){echo "卡商胜诉";}if($vo['status']==10){echo "兼职胜诉";} ?>             
                     ...
                     <?php if($vo['status']==2){ ?>   
                    <a href="javascript:del('<?php echo ($vo["id"]); ?>','<?php echo U('Qudao/heshijine',array('id'=>$vo['id'],'keyword'=>$keyword,'keyword2'=>$keyword2,'keyword3'=>$keyword3,'keyword4'=>$keyword4,'keyword5'=>$keyword5,'p'=>$p));?>');" style="display: block;background:#003BB3;color:#FFF;padding:3px 5px;border-radius: 5px;">有效</a>&nbsp;&nbsp;
					<a href="javascript:del('<?php echo ($vo["id"]); ?>','<?php echo U('Qudao/heshijine2',array('id'=>$vo['id'],'keyword'=>$keyword,'keyword2'=>$keyword2,'keyword3'=>$keyword3,'keyword4'=>$keyword4,'keyword5'=>$keyword5,'p'=>$p));?>');" style="display: block;background:#003BB3;color:#FFF;padding:3px 5px;border-radius: 5px;">无效</a>  
					 <?php } ?>  
