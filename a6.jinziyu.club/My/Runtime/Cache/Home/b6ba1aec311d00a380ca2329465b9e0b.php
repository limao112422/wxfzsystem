...
<div class="filter">
    <form action="<?php echo U(GROUP_NAME.'/yongjin');?>" method="post">
        <input name="keyword" type="text" placeholder="搜索：姓名/手机号" class="inpMain" value="<?php echo ($keyword); ?>" size="20" />
		/
...
<div id="list">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td align="center"><?php echo ($vo["chantit"]); ?></td>
