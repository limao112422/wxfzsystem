		...
		<div class="box">
			<div class="box-header">
				...
				<div class="box-tools" style="left:10px;">
					<form class="form-inline" method="post" action="<?php echo U(GROUP_NAME.'/Caiwu_index');?>">	
						<div class="form-group">
                           <select name="keyword2" id="status" class="form-control" default="">
								<option value="">用户类别</option>
								<option value="1">用户</option>
								<option value="2">下单员</option>
							  </select>
                                <input name="keyword" type="text" style="width:100px;" class="inpMain" placeholder="搜索：用户id" value="<?php echo ($keyword); ?>" >
			...
			<div class="box-body">
				<table class="table table-bordered table-hover table-striped text-center">
					...
					<td align="center"><?php echo ($vo["chanid"]); ?></td>
