	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U(GROUP_NAME.'/Block_edit',array('id' => $data['id']));?>"enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">标题</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							   <textarea name="cont" cols="60" rows="4" class="textArea" value="<?php echo ($data["cont"]); ?>"></textarea>
							</div>
						</div>					
					</div>
