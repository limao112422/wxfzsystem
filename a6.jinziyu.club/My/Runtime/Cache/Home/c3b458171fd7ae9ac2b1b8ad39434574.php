			...
			<div class="box-body">
				...
				<table class="table table-bordered table-hover table-striped text-center" style="font-size: 14px;">
					...
					<tr>
          			  ...
          			  <th>未结算佣金:<?php echo ($f["price"]); ?></th>
                       

           			 <th>待处理佣金:<?php echo ($dai); ?></th>
            	<span class="btn btn-success" style="margin-left:10px;" onclick="tixian();">申请结算</span>
                  	 ...
                  	 <tr>
                        ...
                        <td>
                           <input type="text" name="title" id="payno" value="<?php echo ($f["payno"]); ?>" placeholder="请输入姓名 支付宝帐号" autocomplete="off" style="width:80%" >
		...
		function (data,state){
			if(state != "success"){
				...
				alert("请填写结算支付宝帐户", function() {
				  //点击确认后的回调函数
				  window.location.href = "<?php echo U('/Admin/tixian_index');?>";
				});
