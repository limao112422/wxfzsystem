		...
		<div class="hui-wrap">
		    ...
		    <div class="hui-list" style="background:#FFFFFF; margin-top:10px;">
		        ...
		        <div class="hui-form-items">
		            ...
		            <input type="text" name="p" class="hui-input" autofocus="autofocus" placeholder="请输入旧密码" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">新密码</div>
		            <input type="text" name="np" class="hui-input" autofocus="autofocus" placeholder="请输入新密码" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">确认密码</div>
		            <input type="text" name="cp" class="hui-input" autofocus="autofocus" placeholder="请再次输入新密码" />
		        </div>
