	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U(GROUP_NAME.'/Admin_edits');?>" enctype="multipart/form-data">
                   <input type="hidden" name="editId" value="<?php echo ($data["id"]); ?>">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="username" class="form-control col-sm-9" value="<?php echo ($data["username"]); ?>">
							</div>
						</div>	
                      <div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">密码</label>
							<div class="col-sm-6">
								<input type="password" name="password" class="form-control col-sm-9" >
							</div>
						</div>	
                            <div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">确认密码</label>
							<div class="col-sm-6">
								<input type="password" name="password_confirm" class="form-control col-sm-9" >
							</div>
						</div>	
                    </div>
					...
					<div class="box-footer">
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-9">
								<button type="button" id="ajaxBtn" class="btn btn-primary">确认</button>
							</div>
						</div>
					</div>
