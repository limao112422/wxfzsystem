			...
			<div class="box-header" style="min-height: 35px;">
				...
				<div class="box-tools" style="left:10px;">
						...
						<div class="form-group">
							<a href="<?php echo U(GROUP_NAME.'/bank_add');?>" class="btn btn-success" style="margin-left:10px;">添加分类</a>
						</div>
			...
			<div class="box-body">
                ...
                <td><?php echo (date("Y/m/d",$vo["time"])); ?></td>
							<td>	
								...
								<a href="javascript:delCat('<?php echo ($vo["name"]); ?>','<?php echo U(GROUP_NAME.'/bank_del',array('id'=>$vo['id']));?>');"  class="cannel_vip btn bg-maroon margin">
