		...
		<div class="hui-wrap">
		    ...
		    <div class="hui-list" style="background:#FFFFFF; margin-top:10px;">
		        ...
		        <div class="hui-form-items">
		        	...
		        	<div style="width:25%" class="hui-form-items-title"><input type="text" name="surname" class="inp" maxlength="2" value="<?php echo ($f["surname"]); ?>" /></div>
		            <input style="width:30%;padding-left:5%;border-left:1px solid #F3F4F5" type="text" name="fname" class="inp" placeholder="名" value="<?php echo ($f["fname"]); ?>" autofocus="autofocus" maxlength="15" />
		        </div>

		        <div class="hui-form-items">
		        	<div style="width:110px"></div>
		        	<div style="width:25%" class="hui-form-items-title" id="btn1">常/曾用名 <img src="/Public/image/help_icon.png" width="13" /></div>
		            <input style="width:15%;padding-left:5%;border-left:1px solid #F3F4F5" type="text" name="uname" class="inp" value="<?php echo ($f["uname"]); ?>" maxlength="2"/>
		            <input style="width:15%;padding-left:5%;border-left:1px solid #F3F4F5" type="text" name="ufname" class="inp" value="<?php echo ($f["ufname"]); ?>" placeholder="名" maxlength="15" />
		        </div>

		        <div class="hui-form-items">
		        	<div style="width:110px"></div>
		        	<div style="width:25%" class="hui-form-items-title" id="btn2">表字 <img src="/Public/image/help_icon.png" width="13" /></div>
		            <input style="width:30%;padding-left:5%;border-left:1px solid #F3F4F5" type="text" name="aname" class="inp" placeholder="表字" value="<?php echo ($f["aname"]); ?>" maxlength="2" />
		        </div>

		        <div class="hui-form-items">
		        	<div style="width:110px"></div>
		        	<div style="width:25%" class="hui-form-items-title" id="btn7">排行 <img src="/Public/image/help_icon.png" width="13" /></div>
		            <input style="width:30%;padding-left:5%;border-left:1px solid #F3F4F5" type="text" name="rank" class="inp" id="btn3" placeholder="选择" value="<?php echo ($f["rank"]); ?>"/>
		        </div>

		        <div class="hui-form-items">
		        	<div style="width:110px"></div>
		        	<div style="width:25%" class="hui-form-items-title">性别</div>
		            <input style="width:30%;padding-left:5%;border-left:1px solid #F3F4F5" type="text" name="sex" class="inp" id="btn4" placeholder="选择" <?php if($f['sex']): ?>value="女"<?php else: ?>value="男"<?php endif; ?> />
		        </div>
		    ...
		    <div class="hui-list" style="background:#FFFFFF" id="x1">
		        <div class="hui-form-items">
		            ...
		            <input type="text" name="member" class="hui-input" placeholder="请输入会员ID，可不填" value="<?php echo ($f["bookd"]["member"]); ?>" />
		        </div>

		        <?php if(($f['type'] == 0) AND ($f['books'] != 0)): ?><div class="hui-form-items">
		        	<div class="hui-form-items-title"><?php if($f['type'] == 3): ?>丈夫<?php else: ?>父亲<?php endif; ?></div>
		            <input type="text" class="hui-input" value="<?php echo ($f["f"]["surname"]); echo ($f["f"]["fname"]); ?>" />
		        </div>

		        <?php if($f['sp']): ?><div class="hui-form-items">
			        	<div class="hui-form-items-title">母亲</div>
			        	<select name="bookz" class="inp">
			        		<?php if(is_array($sp)): foreach($sp as $key=>$v): if($f["bookz"] == $v['id']): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["surname"]); echo ($v["fname"]); ?></option><?php endif; ?>
		        ...
		        <div class="hui-form-items">
		            ...
		            <input type="text" name="birthday" class="hui-input" placeholder="农历 8位数日期，必填" value="<?php echo ($f["bookd"]["birthday"]); ?>" maxlength="8" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">出生时辰</div>
		            <input type="text" name="bhour" class="hui-input" id="btn6" placeholder="选择" maxlength="2" value="<?php echo ($f["bookd"]["bhour"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">出生地址</div>
		            <input type="text" name="baddress" class="hui-input" placeholder="输入出生地址" value="<?php echo ($f["bookd"]["baddress"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">现居地址</div>
		            <input type="text" name="address" class="hui-input" placeholder="输入现居地址" value="<?php echo ($f["bookd"]["address"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">联系电话</div>
		            <input type="text" name="mobile" class="hui-input" placeholder="电话号码" maxlength="11" value="<?php echo ($f["bookd"]["mobile"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">微信</div>
		            <input type="text" name="weixin" class="hui-input" placeholder="微信" value="<?php echo ($f["bookd"]["weixin"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">QQ</div>
		            <input type="text" name="qq" class="hui-input" placeholder="QQ号码" value="<?php echo ($f["bookd"]["qq"]); ?>" />
		        </div>
		    </div>
		    ...
		    <div class="hui-list" style="background:#FFFFFF;display:none" id="x2">
		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">绑定ID</div>
		            <input type="text" name="surmember" class="hui-input" placeholder="请输入纪念馆ID，可不填" value="<?php echo ($f["bookd"]["surmember"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">出生日期</div>
		            <input type="text" name="birthdays" class="hui-input" placeholder="农历 8位数日期，必填" value="<?php echo ($f["bookd"]["birthdays"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">出生时辰</div>
		            <input type="text" name="bhours" class="hui-input" id="btn6" placeholder="选择" maxlength="2" value="<?php echo ($f["bookd"]["bhours"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">出生地址</div>
		            <input type="text" name="baddresss" class="hui-input" placeholder="输入出生地址"  value="<?php echo ($f["bookd"]["baddresss"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">逝世日期</div>
		            <input type="text" name="deathdate" class="hui-input" placeholder="农历 8位数日期，必填" maxlength="8" value="<?php echo ($f["bookd"]["deathdate"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">逝世时辰</div>
		            <input type="text" name="dhour" class="hui-input" id="btn5" placeholder="选择" maxlength="2" value="<?php echo ($f["bookd"]["dhour"]); ?>" />
		        </div>

		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">安厝地</div>
		            <input type="text" name="daddress" class="hui-input" placeholder="请输入安厝地" value="<?php echo ($f["bookd"]["daddress"]); ?>" />
		        </div>
		    </div>
		    ...
		    <div class="hui-list" style="background:#FFFFFF;">
		        <div class="hui-form-items">
		            <textarea placeholder="用于查阅世系图或导出制作实体家谱时显示的成员资料（不填则根据成员其他资料显示内容）" name="print" style="width:100%;border: 0;font-size: 13px" rows="5"><?php echo ($f["bookd"]["print"]); ?></textarea>
		        </div>
		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">收养</div>
		        	<select name="mtype" class="hui-input">
		        		<?php if($f.bookd.mtype): ?><option value="1">是</option><?php endif; ?>
		        ...
		        <div class="hui-form-items">
		            ...
		            <input type="text" name="mmember" class="hui-input" placeholder="无，可不填" value="<?php echo ($f["bookd"]["mmember"]); ?>" />
		        </div>
		    </div>
		    <div style="color:#999;font-size: 12px;padding:5px 10px">个人简介（用于详细资料显示）</div>
		    <div class="hui-list" style="background:#FFFFFF;">
		    	<div class="hui-form-items">
		            <textarea placeholder="请输入个人简介" name="description" style="width:100%;border: 0;font-size: 13px" rows="5"><?php echo ($f["bookd"]["description"]); ?></textarea>
		        </div>
		    </div>

		    <div class="hui-list" style="background:#FFFFFF;border: 1px solid #fff;">
		    	<div style="margin:50px 0 30px 0;padding:10px;">
			        <input type="submit" class="hui-button hui-button-large hui-primary" value="更 新" />
			    </div>
		    </div>
