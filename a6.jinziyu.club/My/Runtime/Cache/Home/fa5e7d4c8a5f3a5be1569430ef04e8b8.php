	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U(GROUP_NAME.'/User_add');?>"enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">姓名</label>
							<div class="col-sm-6">
								<input type="text" name="nick" class="form-control col-sm-9" value="">
							</div>
						</div>					

						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">手机号</label>
							<div class="col-sm-6">
								<input type="text" name="mobile" class="form-control col-sm-9" value="">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="password" class="form-control col-sm-9" value="">
								<p class="help-block help-block-error col-sm-7 col-xs-10"></p>
							</div>
						</div>
