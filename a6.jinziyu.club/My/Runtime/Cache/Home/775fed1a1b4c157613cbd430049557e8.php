	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U(GROUP_NAME.'/Img_edit',array('id' => $data['id']));?>" enctype="multipart/form-data">
					<div class="box-body">
									
						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">图片</label>
							<div class="col-sm-6">
							  <input type="text" name="img" id="thumbnail" value="<?php echo ($data["img"]); ?>" size="30" class="inpMain" />
				...
				<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="tit" class="form-control col-sm-9" value="<?php echo ($data["tit"]); ?>">
							</div>
						</div>		
                  <div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">链接</label>
							<div class="col-sm-6">
								<input type="text" name="url" class="form-control col-sm-9" value="<?php echo ($data["url"]); ?>">
							</div>
						</div>		
					<!-- /.box-body -->
