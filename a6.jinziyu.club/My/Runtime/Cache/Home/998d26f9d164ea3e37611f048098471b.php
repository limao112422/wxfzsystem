	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form id="fordw"class="form-horizontal" style="margin-top:30px" method="POST" action="<?php echo U(GROUP_NAME.'/text_add');?>"enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label for="exampleInputEmail1" class="control-label col-sm-3">文章分类</label>
							<div class="col-sm-6">
								<select name="type">
									<option value="0" >请选择</option>
                                    <option value="1">公告</option>
									<option value="2">最新活动</option>
									<option value="3">辅助指南</option>
                            </select>
							</div>
						</div>					
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								  <textarea  id="demo" style="display: none;" name="text" cols="60" rows="4" class="textArea"></textarea>
					...
					<div class="box-footer">
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-9">
								<button type="button" onclick="tijiao()"id="ajaxBtn" class="btn btn-primary">添加</button>
							</div>
						</div>
					</div>
