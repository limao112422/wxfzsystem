				...
				<div class="hui-list" style="background:#FFFFFF; margin-top:10px;border:0">
					<table style="width:100%;padding:10px">
					  ...
					  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
						    ...
						    <td style="width:60%"><?php echo ($v["bank"]); ?>&<?php echo ($v["name"]); ?></td>
						    <td style="width:10%"><?php echo ((isset($v["sort"]) && ($v["sort"] !== ""))?($v["sort"]):"0"); ?></td>
						    <td style="width:20%"><a href="<?php echo U('/admin/cardedit',array('id'=>$v['id']));?>">编辑</a>&nbsp;&nbsp;<a href="<?php echo U('/admin/carddel',array('id'=>$v['id']));?>">删除</a></td>
