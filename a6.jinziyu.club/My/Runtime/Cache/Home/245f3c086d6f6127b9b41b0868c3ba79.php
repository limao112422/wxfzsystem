		...
		<div class="hui-wrap">
		    ...
		    <div class="hui-list" style="background:#FFFFFF; margin-top:10px;">
		        ...
		        <div class="hui-form-items">
		        	...
		        	<div style="width:25%" class="hui-form-items-title"><input type="text" name="surname" class="inp" maxlength="2" value="<?php echo ($f["sur"]); ?>" /></div>
		        ...
		        <div class="hui-form-items">
		            ...
		            <input style="width:15%;padding-left:5%;border-left:1px solid #F3F4F5" type="text" name="uname" class="inp" value="<?php echo ($f["sur"]); ?>" maxlength="2"/>
		        ...
		        <div class="hui-form-items">
		        	<div style="width:110px"></div>
		        	<div style="width:25%;" class="hui-form-items-title">特殊情况</div>
		        	<select name="s" style="width:30%;padding-left:5%;border-left:1px solid #F3F4F5" class="inp">
		        		<option value="0">无</option>
		        		<option value="1">资料失去考证</option>
		        		<option value="2">未出生或未过门</option>
		        	</select>
		        </div>
		    ...
		    <div class="hui-list" style="background:#FFFFFF" id="x1">
		        <div class="hui-form-items">
		            ...
		            <input type="text" name="member" class="hui-input" placeholder="请输入本成员ID，可不填" />
		        </div>
		    ...
		    <div class="hui-list" style="background:#FFFFFF;display:none" id="x2">
		        ...
		        <div class="hui-form-items">
		        	<div class="hui-form-items-title">出生日期</div>
		            <input type="text" name="birthdays" class="hui-input" placeholder="农历 8位数日期" />
		        </div>
		        ...
		        <div class="hui-form-items">
		            ...
		            <input type="text" name="deathdate" class="hui-input" placeholder="农历 8位数日期" maxlength="8" />
		        </div>
		    ...
		    <div class="hui-list" style="background:#FFFFFF;border: 1px solid #fff;">
		    	<div style="margin:50px 0 30px 0;padding:10px;">
			        <input type="submit" class="hui-button hui-button-large hui-primary" value="添 加" />
			    </div>
		    </div>
