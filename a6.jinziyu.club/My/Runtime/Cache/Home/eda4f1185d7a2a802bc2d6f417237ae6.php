...
function yuedududu(){
        layer.confirm(
                '本系统源码不得未经授权进行二次出售转让，使用本系统需要遵守法律法规，办理相关资质后方可从事商业活动，不得从事非法活动，不得利用应用及服务发表、传送、传播、储存危害国家安全、祖国统一、社会稳定的内容，或侮辱诽谤、色情、暴力、引起他人不安及任何违反国家法律法规政策的内容，违反上述条例带来的相关责任和赔偿由运营者单独承担，与系统开发者无关，并有权收回其授权权利，保留追偿权利！（为了不必要的麻烦，请购买正版系统）',{btn: ['我完全同意以上协议'],closeBtn: 0,title: "系统使用协议（同意后 协议消失）"},
                function (){
					var tt="本系统源码不得未经授权进行二次出售转让，使用本系统需要遵守法律法规，办理相关资质后方可从事商业活动，不得从事非法活动，不得利用应用及服务发表、传送、传播、储存危害国家安全、祖国统一、社会稳定的内容，或侮辱诽谤、色情、暴力、引起他人不安及任何违反国家法律法规政策的内容，违反上述条例带来的相关责任和赔偿由运营者单独承担，与系统开发者无关，并有权收回其授权权利，保留追偿权利！（为了不必要的麻烦，请购买正版系统）";
                    //存储到数据库内
					//查询是否阅读过
					$.post(
...
<form action="<?php echo U(GROUP_NAME.'/card_add');?>" method="post">
...
<tr>
            ...
            <td>
                ...
                <input type="text" name="timg" id="thumbnail2" value="" size="30" class="inpMain" />
		...
		<tr>
            ...
            <td>
                ...
                <input type="text" name="member" value="" size="50" class="inpMain" />
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="day" value="" size="50" class="inpMain" />
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="red" value="" size="50" class="inpMain" />
		...
		<tr>
            ...
            <td>
                ...
                <input type="text" name="pay" value="" size="50" class="inpMain" />
		...
		<tr>
            ...
            <td>
                ...
                <input type="text" name="eryong" value="" size="50" class="inpMain" />
		...
		<tr>
            ...
            <td>
                ...
                <input type="text" name="sanyong" value="" size="50" class="inpMain" />
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="sday" value="" size="50" class="inpMain" />
		...
		<tr>
            ...
            <td>
                ...
                <input type="text" name="link" value="" size="50" class="inpMain" />
        ...
        <tr>
            ...
            <td>
				<textarea name="d" cols="60" rows="4" class="textArea"></textarea>
		...
		<tr>
            ...
            <td>
                ...
                <input type="text" name="id" value="" size="50" class="inpMain" />
